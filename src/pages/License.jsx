                            ...
                            <div className="text-sm text-gray-600 space-y-6 h-[600px] overflow-y-auto pr-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="border-l-4 border-green-500 pl-4">
                                        <h3 className="font-semibold text-gray-800 mb-2">3. Data Protection & Privacy</h3>
                                        <p className="text-gray-600">
                                    ...
                                    <div className="border-l-4 border-yellow-500 pl-4">
                                        <h3 className="font-semibold text-gray-800 mb-2">4. Copyright & Ownership</h3>
                                        <p className="text-gray-600">
                                            We own all rights to this software, including the name, code, and design. You are only allowed to use it, not claim ownership.
                                        </p>
                                    </div>
                                    ...
                                    <div className="border-l-4 border-indigo-500 pl-4">
                                        <h3 className="font-semibold text-gray-800 mb-2">6. Support & Updates</h3>
                                        <p className="text-gray-600">
