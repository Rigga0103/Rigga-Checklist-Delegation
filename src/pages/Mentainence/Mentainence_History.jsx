...
function Mentainence_History() {
      ...
      .filter((item) => {
        ...
        const matchesMachine =
          selectedMachines.length > 0
            ? selectedMachines.includes(item["col2"])
            : true;

        return (
          matchesSearch && matchesMember && matchesMachine && matchesDateRange
        );
      })
      .sort((a, b) => {
  ...
  const fetchSheetData = useCallback(async () => {
    try {
      ...
      console.log("historyrow", historyRows);
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      // ADD THIS:
      if (showMachineDropdown && !event.target.closest(".relative")) {
    ...
    document.addEventListener("mousedown", handleClickOutside);
    return () => document.removeEventListener("mousedown", handleClickOutside);
  }, [showMemberDropdown, showMachineDropdown]); // ADD showMachineDropdown to dependency array
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50 sticky top-0 z-10">
                    <tr>
                      ...
                      {/* Hide Machine Name column for admin in history view */}
                      ...
                      <tr>
                        ...
                        <td
                          colSpan={
                            ...
                            (userRole !== "admin" && isAdmin ? 1 : 0) + // Machine Name column
...
export default Mentainence_History;
