...
const Maintenance_Form = () => {
  ...
  return (
    <AdminLayout>
      {/* QR Code Generator - Points to public form URL */}
      <QRCodeGenerator
        customUrl={`${window.location.origin}/public/repairing-form`}
        title="Scan to Open Form"
        description="Scan this QR code with your mobile device to open the Repairing Request Form (No login required)"
        position="top-right"
        size={220}
      />
