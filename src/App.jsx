...
import Mentainence from "./pages/Mentainence/Mentainence";
import TaskDetails from "./pages/Mentainence/TaskDetails";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/mentenance-calendar"
          element={
            <ProtectedRoute>
              <Mentainence_Calender />
            </ProtectedRoute>
          }
        />
        <Route
        ...
        <Route
          path="/tasks/:taskNo/:serialNo/:taskType"
          element={<TaskDetails />}
        />
